...
function calcular() {
  ...
  // Validaciones
  if (!c1 || !c7 || !c8 || !e2 || !vin || !tipo || !año || (!esHibrido && vin==='otros' && tipo==='TURISMO' && !motor)) {
  ...
  const detalles = [
    ...
    ['ISC', isc, 'hnl'],
    ['ISV', isv, 'hnl'],
    ['TOTAL IMPUESTOS HONDURAS', dai+isc+isv, 'hnl'],
    ['ECOTASA', ecotasa, 'hnl'],
  ...
  document.getElementById('results').innerHTML = `
    <div style="text-align:center;">
      ...
      <div id="detalleResultados" style="display:none;">
        <table class="tabla-detalles"><tr><th>Concepto</th><th>Valor</th></tr>${html}</table>
      </div>
    </div>
  `;
}
